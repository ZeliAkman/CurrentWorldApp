package com.example.cuurentworld.ui.adapter
...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    ...
    lateinit var articleSoure :TextView
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ...
        articleSoure = holder.itemView.findViewById(R.id.articleSource)
        ...
        holder.itemView.apply {
            ...
            articleSoure.text = article.source?.name
